...
@section('bodySection')
    ...
    <div class="w-full mx-auto p-6 lg:p-8">
        ...
        <div class="w-full rounded-md bg-gray-50 m-[20] p-[10]" >
            <table class="w-full">
               <thead>
               <tr>
                   <th> No.</th>
